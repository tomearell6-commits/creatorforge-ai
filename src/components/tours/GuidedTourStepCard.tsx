...
export function GuidedTourStepCard({
  ...
  return (
    <div className="fixed z-[95] w-[calc(100vw-2rem)] max-w-xs rounded-2xl border border-border bg-card p-4 shadow-2xl" style={style} role="dialog">
      <div className="mb-2 flex items-center justify-between">
        ...
        <button onClick={onSkip} className="text-muted-foreground hover:text-foreground" title="Skip tour"><X className="h-4 w-4" /></button>
      </div>
