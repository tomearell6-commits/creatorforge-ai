    ...
    <div className="space-y-6">
      <Card className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div><CardTitle>CreatorForge Autopilot</CardTitle><p className="text-sm text-muted-foreground">Configure your strategy once — Autopilot plans, schedules, and (in Full mode) publishes.</p></div>
        </div>
