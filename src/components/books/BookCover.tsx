  ...
  return (
    <div className="space-y-4">
      <Card className="space-y-3">
        ...
        <Button variant="accent" disabled={!bookId || !prompt.trim() || busy} onClick={generate}>{busy ? <Loader2 className="h-4 w-4 animate-spin" /> : <Sparkles className="h-4 w-4" />} Generate cover (~{BOOK_CREDIT_COSTS.cover} cr)</Button>
