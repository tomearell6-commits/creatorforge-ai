          ...
          return (
            <Reveal key={it.title} delay={i * 90}>
              <div className="relative flex items-center gap-4 rounded-xl border border-border bg-card p-4 shadow-sm">
                <div className="z-10 flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-brand-900 text-brand-300 dark:bg-brand-950/50 dark:text-brand-300">
