        ...
        return (
          <Reveal key={f.title} delay={(i % 3) * 70}>
            <div className="group flex h-full flex-col gap-3 rounded-2xl border border-border bg-card p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-brand-400 hover:shadow-md">
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-900 text-brand-300 transition-transform duration-300 group-hover:scale-110 dark:bg-brand-950/50 dark:text-brand-300">
