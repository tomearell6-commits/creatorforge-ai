  ...
  return (
    <div className="space-y-5">
      <div className="relative">
        ...
        <Input value={q} onChange={(e) => setQ(e.target.value)} placeholder="Search all tools and templates…" aria-label="Search all tools and templates" className="pl-9" />
      </div>
          ...
          return (
            <Card key={c.categoryId} className="flex flex-col gap-3">
              <div className="flex items-center gap-2">
                <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-brand-900 text-brand-300"><Icon className="h-5 w-5" /></span>
