...
export const SOCIAL_PROVIDERS: Record<SocialProviderId, SocialProvider> = {
  facebook: {
    ...
    oauthSupported: true, content: SUP, publishing: M, scheduling: M, analytics: M, inbox: M, comments: M, ads: M, profileEditing: M,
    tokenRefresh: true, live: false, requiredPermissions: ["pages_manage_posts", "pages_read_engagement"],
    knownLimits: "Live posting/insights need a reviewed Meta app + business verification.",
  },
  instagram: {
    id: "instagram", name: "Instagram Business", brandIcon: "instagram", accountTypes: ["business"],
    oauthSupported: true, content: SUP, publishing: M, scheduling: M, analytics: M, inbox: M, comments: M, ads: M, profileEditing: LIM,
    tokenRefresh: true, live: false, requiredPermissions: ["instagram_content_publish", "instagram_basic"],
    knownLimits: "Requires linked Facebook Page + reviewed Meta app. Stories via API are limited.",
  },
  linkedin: {
    ...
    tokenRefresh: true, live: false, requiredPermissions: ["w_organization_social", "r_organization_social"],
    knownLimits: "Needs LinkedIn Marketing Developer Platform approval. No inbox API.",
  },
  tiktok: {
    id: "tiktok", name: "TikTok Business", brandIcon: "tiktok", accountTypes: ["business"],
    oauthSupported: true, content: SUP, publishing: M, scheduling: M, analytics: LIM, inbox: NA, comments: NA, ads: M, profileEditing: NA,
    tokenRefresh: true, live: false, requiredPermissions: ["video.publish", "user.info.basic"],
    knownLimits: "Content Posting API requires app approval. No official trend-data API — trend tools are planning aids only.",
  },
  youtube: {
