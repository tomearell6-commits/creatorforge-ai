    ...
    sections: [
      {
        ...
        children: [
          ...
          c("ai-shorts", "AI Shorts", "/dashboard/create/ai-shorts", Clapperboard, "Vertical short-form for Reels/Shorts/TikTok", 2),
          c("seo-articles", "SEO Articles", "/dashboard/seo", Search, "SEO Studio: generate & publish articles", 3, { tour: "seo-studio" }),
          c("blog-writer", "Blog Writer", "/dashboard/generate", FileText, "Scripts, blogs and written content", 4),
          c("image-generator", "Image Generator", "/dashboard/create?group=image", ImageIcon, "AI images and thumbnails", 5),
          c("voiceover", "Voiceover Studio", "/dashboard/voice", Music, "AI voiceovers in premium voices", 6),
          c("podcast-scripts", "Podcast Scripts", "/dashboard/create/podcast-scripts", Type, "Episode outlines and show notes", 7),
          c("templates", "Templates", "/dashboard/templates", LayoutTemplate, "Ready-made content templates", 8, { tour: "templates" }),
          c("media-library", "Media Library", "/dashboard/assets", Library, "Everything you've generated", 9),
          c("render-queue", "Render Queue", "/dashboard/render", Server, "Render projects to MP4", 10, { tour: "render-queue" }),
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        route: "/dashboard/studio/business", icon: Briefcase, order: 4,
        description: "Leads, email, teams and partner programs.",
        children: [
          c("leads", "Lead Generator", "/dashboard/leads", Target, "Find and qualify B2B leads", 1, { requiredPlan: "pro" }),
          c("email-assistant", "AI Email Assistant", "/dashboard/email", Mail, "Inbox triage, drafts and summaries", 2),
          c("crm", "CRM", "/dashboard/leads", Users, "Customer relationship management", 3, { isEnabled: false }),
          c("team", "Team & Workspaces", "/dashboard/team", Users, "Members, roles and client workspaces", 4),
          c("affiliate", "Affiliate Program", "/dashboard/affiliate", Handshake, "Earn 30% commissions", 5),
          c("referrals", "Referral Program", "/dashboard/referrals", Gift, "Invite friends, earn credits", 6),
          c("invoices", "Invoices", "/dashboard/billing/invoices", FileText, "Your receipts and invoices", 7),
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        children: [
          ...
          c("support", "Support", "/dashboard/support", LifeBuoy, "Help center and tickets", 4),
        ],
      },
    ],
  },
