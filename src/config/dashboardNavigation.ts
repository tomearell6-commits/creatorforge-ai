    ...
    sections: [
      {
        ...
        children: [
          ...
          c("ai-shorts", "AI Shorts", "/dashboard/create/ai-shorts", Clapperboard, "Vertical short-form for Reels/Shorts/TikTok", 3, { isEnabled: false }),
          ...
          c("podcast-scripts", "Podcast Scripts", "/dashboard/create/podcast-scripts", Type, "Episode outlines and show notes", 8, { isEnabled: false }),
