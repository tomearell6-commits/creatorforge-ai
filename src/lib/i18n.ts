...
const en: Dict = {
  ...
  sections: {
    workflowEyebrow: "Your workflow", workflowTitle: "From Solo Creators to Growing Brands", workflowSubtitle: "CreatorForge helps creators and businesses produce content faster, test more ideas, and publish consistently.",
    ...
    demoEyebrow: "See it in action", demoTitle: "From idea to published video — in minutes", demoSubtitle: "Watch how CreatorForge turns a single prompt into a finished, publish-ready video.", demoCta: "Try it free →",
    testimonialsEyebrow: "Testimonials", testimonialsTitle: "Loved by creators worldwide", testimonialsSubtitle: "Join thousands of creators, marketers, and entrepreneurs who trust CreatorForge for their content.",
    ...
    ctaTitle: "Start creating with CreatorForge today", ctaSubtitle: "Your first project is free — no credit card required.", ctaButton: "Start Creating Now",
  },
};
...
const DICTS: Record<Locale, Dict> = {
  ...
  es: {
    ...
    sections: {
      workflowEyebrow: "Tu flujo de trabajo", workflowTitle: "De creadores individuales a marcas en crecimiento", workflowSubtitle: "CreatorForge ayuda a creadores y empresas a producir contenido más rápido, probar más ideas y publicar de forma constante.",
      ...
      demoEyebrow: "Míralo en acción", demoTitle: "De la idea al video publicado, en minutos", demoSubtitle: "Mira cómo CreatorForge convierte una simple indicación en un video listo para publicar.", demoCta: "Pruébalo gratis →",
      testimonialsEyebrow: "Testimonios", testimonialsTitle: "Adorado por creadores de todo el mundo", testimonialsSubtitle: "Únete a miles de creadores, especialistas en marketing y emprendedores que confían en CreatorForge para su contenido.",
      ...
      ctaTitle: "Empieza a crear con CreatorForge hoy", ctaSubtitle: "Tu primer proyecto es gratis, sin tarjeta de crédito.", ctaButton: "Empieza a crear ahora",
    },
  },
  fr: {
    ...
    sections: {
      workflowEyebrow: "Votre flux de travail", workflowTitle: "Des créateurs solos aux marques en croissance", workflowSubtitle: "CreatorForge aide les créateurs et les entreprises à produire du contenu plus vite, tester plus d'idées et publier régulièrement.",
      ...
      demoEyebrow: "Voir en action", demoTitle: "De l'idée à la vidéo publiée, en quelques minutes", demoSubtitle: "Découvrez comment CreatorForge transforme une simple consigne en une vidéo prête à publier.", demoCta: "Essayer gratuitement →",
      testimonialsEyebrow: "Témoignages", testimonialsTitle: "Adopté par des créateurs du monde entier", testimonialsSubtitle: "Rejoignez des milliers de créateurs, marketeurs et entrepreneurs qui font confiance à CreatorForge pour leur contenu.",
      faqTitle: "Questions fréquentes", faqSupportPre: "Vous ne trouvez pas la réponse ? Contactez notre ", faqSupportLink: "support client",
      ctaTitle: "Commencez à créer avec CreatorForge dès aujourd'hui", ctaSubtitle: "Votre premier projet est gratuit, sans carte bancaire.", ctaButton: "Commencer à créer",
    },
  },
  de: {
    ...
    sections: {
      workflowEyebrow: "Dein Workflow", workflowTitle: "Von Solo-Creators zu wachsenden Marken", workflowSubtitle: "CreatorForge hilft Creators und Unternehmen, schneller Inhalte zu produzieren, mehr Ideen zu testen und konstant zu veröffentlichen.",
      ...
      demoEyebrow: "In Aktion sehen", demoTitle: "Von der Idee zum veröffentlichten Video – in Minuten", demoSubtitle: "Sieh, wie CreatorForge aus einer einzigen Eingabe ein fertiges, veröffentlichungsreifes Video macht.", demoCta: "Kostenlos testen →",
      testimonialsEyebrow: "Erfahrungsberichte", testimonialsTitle: "Beliebt bei Creators weltweit", testimonialsSubtitle: "Schließe dich Tausenden von Creators, Marketern und Unternehmern an, die CreatorForge für ihre Inhalte vertrauen.",
      ...
      ctaTitle: "Starte noch heute mit CreatorForge", ctaSubtitle: "Dein erstes Projekt ist kostenlos – keine Kreditkarte nötig.", ctaButton: "Jetzt loslegen",
    },
  },
  pt: {
    ...
    sections: {
      workflowEyebrow: "Seu fluxo de trabalho", workflowTitle: "De criadores individuais a marcas em crescimento", workflowSubtitle: "O CreatorForge ajuda criadores e empresas a produzir conteúdo mais rápido, testar mais ideias e publicar com consistência.",
      ...
      demoEyebrow: "Veja em ação", demoTitle: "Da ideia ao vídeo publicado, em minutos", demoSubtitle: "Veja como o CreatorForge transforma um único comando em um vídeo pronto para publicar.", demoCta: "Experimente grátis →",
      testimonialsEyebrow: "Depoimentos", testimonialsTitle: "Amado por criadores no mundo todo", testimonialsSubtitle: "Junte-se a milhares de criadores, profissionais de marketing e empreendedores que confiam no CreatorForge para o seu conteúdo.",
      ...
      ctaTitle: "Comece a criar com o CreatorForge hoje", ctaSubtitle: "Seu primeiro projeto é grátis — sem cartão de crédito.", ctaButton: "Comece a criar agora",
    },
  },
};
