...
export function buildScriptPrompt({ category, idea, title, tone, length }: ScriptPromptInput) {
  ...
  const system = [
    "You are CreatorForge AI, an expert scriptwriter for faceless short-form video content.",
...
---
(Generated by the CreatorForge AI placeholder engine — set ANTHROPIC_API_KEY to enable
